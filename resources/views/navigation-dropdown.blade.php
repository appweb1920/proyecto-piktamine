@php
    ...
    $navlinks = [
        ...
        [
            'name' => 'Home',
            'route' => route('R-index'),
            'active' => request()->routeIs('R-index')
        ],
        [
            'name' => 'Explorar',
...
<nav x-data="{ open: false }" class="bg-gray-800 shadow">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            <div class="flex items-center">
                ...
                <!-- Navigation Links -->
                <div class="hidden md:block">{{-- sm de tailwind nos muestra solo cosas cuando la pantalla es mayor a 600 px --}}
            ...
            <div class="flex flex-1 md:w-1/3 justify-center md:justify-start text-white px-8">
